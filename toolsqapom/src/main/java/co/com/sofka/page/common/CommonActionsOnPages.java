...
public class CommonActionsOnPages extends BaseSikulix{
    ...
    private static final String PATH_FILE = "C:\\Users\\ThinkPad\\Desktop\\CURSO DE PROGRAMACION\\TrainingSofka\\AutomationOHRM_Pfactory\\file.txt";
    ...
    protected void withExplicitWaitClickOnSendPath(WebElement webElement) {
        webDriverExplicitWait.until(elementToBeClickable(webElement)).sendKeys(PATH_FILE);
    }
